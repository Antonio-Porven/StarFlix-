...
urlpatterns = [
    ...
    path('moviegenrelist/', views.moviegenrelist, name='moviegenrelist'),
    path('movies/moviegenreresults/<int:category_id>/', views.moviegenreresults, name='moviegenreresults'),
